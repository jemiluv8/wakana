...
const claudeButtonVariants = cva(
...
export interface ClaudeButtonProps
  extends React.ButtonHTMLAttributes<HTMLButtonElement>,
    VariantProps<typeof claudeButtonVariants> {
  asChild?: boolean;
  loading?: boolean;
}
...
const ClaudeButton = React.forwardRef<HTMLButtonElement, ClaudeButtonProps>(
  ({ className, variant, size, asChild = false, loading, children, disabled, ...props }, ref) => {
    ...
    return (
      <Comp
        className={cn(claudeButtonVariants({ variant, size, className }))}
        ref={ref}
...
export { ClaudeButton, claudeButtonVariants };