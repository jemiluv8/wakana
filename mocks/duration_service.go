...
func (m *DurationServiceMock) Get(time time.Time, time2 time.Time, user *models.User, f *models.Filters, sliceBy string) (models.Durations, error) {
	args := m.Called(time, time2, user, f, sliceBy)
