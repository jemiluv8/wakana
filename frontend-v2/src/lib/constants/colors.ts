...
export const COLORS: ColorCategoryRecord = {
  ...
  categories: {
    browsing: "#e59215",
    building: "#e8ce3d",
    code_reviewing: "#34f5db",
    coding: "#1f9aef",
    communication: "#6f2170",
    debugging: "#c49af9",
    designing: "#9061ca",
    indexing: "#fff09d",
    learning: "#38a2eb",
    manual_testing: "#34be61",
    meeting: "#fd1464",
    planning: "#ff4585",
    researching: "#4cbfc0",
...
function extractOptionsFrom(source: Record<string, any>, key: string) {
  return Object.keys(source[key]).map((key) => ({ label: key, value: key }));
}

export const LANGUAGE_OPTIONS = extractOptionsFrom(COLORS, "languages");
export const EDITOR_OPTIONS = extractOptionsFrom(COLORS, "editors");
export const CATEGORY_OPTIONS = extractOptionsFrom(COLORS, "categories");

export const SAMPLE_COLORS_OLD = [
  "#16cf41",
  "#209af0",
  // "#d62829",
  // "#FF7A00",
