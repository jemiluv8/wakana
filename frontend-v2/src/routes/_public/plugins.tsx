...
export const metadata = {
  ...
  description:
    "Compatible with all WakaTime plugins. Track your coding activity across 40+ editors and IDEs.",
};
...
const popularPlugins = [
  {
    name: "VS Code",
    description:
      "Most popular code editor with automatic time tracking and productivity metrics",
    icon: "🆚",
  ...
  },
  {
    name: "IntelliJ IDEA",
    description:
      "Full-featured IDE with robust WakaTime plugin support for Java development",
    icon: "💡",
  ...
  },
  {
    name: "Vim/Neovim",
    description:
      "Powerful text editors for command-line enthusiasts with lightweight tracking",
    icon: "⚡",
  ...
  },
  {
    name: "Sublime Text",
    description:
      "Fast and lightweight text editor with seamless WakaTime integration",
    icon: "📝",
  ...
  },
  {
    name: "PyCharm",
    description:
      "Python-focused IDE with comprehensive development time tracking",
    icon: "🐍",
  ...
  },
  {
    name: "Emacs",
    description:
      "Extensible, customizable text editor with Elisp-based WakaTime integration",
    icon: "🔧",
...
export default function RouteComponent() {
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-primary">
      ...
      <div className="space-y-8">
        <div className="bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
          ...
          <p className="text-blue-800 dark:text-blue-200 leading-relaxed">
            Wakana works with all existing WakaTime plugins. Simply point your
            plugin configuration to your Wakana instance and continue using your
            favorite editor without any changes to your workflow.
          </p>
        </div>
        ...
        <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6 text-secondary">
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium">
                  Download the plugin for your editor
                </p>
                <a
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-medium">
                  Start coding and track your activity
                </p>
                <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">
                  Your coding time will automatically be tracked and sent to
                  your Wakana dashboard
                </p>
              </div>
            </div>
          </div>
