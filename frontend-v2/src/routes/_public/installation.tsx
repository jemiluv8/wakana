...
export default function RouteComponent() {
  return (
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-primary">
              ...
              <div className="flex-1">
                ...
                {step.action && (
                  <a
                    ...
                    className="inline-flex items-center gap-2 bg-primary px-4 py-2 rounded-md text-sm font-medium hover:bg-primary/90 text-primary-foreground transition-colors"
                  >
                    {step.action.text}
                ...
                {step.details && (
                  <div className="space-y-2 mt-4">
                    {step.details.map((detail, i) => (
                      <div key={i}>
                        <code className="text-sm bg-gray-100 dark:bg-gray-800 text-primary-foreground px-2 py-1 rounded">
                          {detail}
                        </code>
                      </div>
                    ))}
      ...
      {/* CTA Section */}
      <div className="mt-16 text-center bg-gray-50 dark:bg-gray-800 rounded-lg p-8 text-primary-foreground">
