...
function LeaderboardCard({
  ...
  return (
    <div className="bg-background border border-border rounded-lg p-4 hover:bg-muted/50 transition-colors text-foreground">
  ...
  return (
    <div className="w-full mx-auto my-auto">
      <div className="mb-6 text-center">
        <h1 className={cn("text-3xl font-bold text-foreground", titleClass)}>
          {title} {subtitle}
        </h1>
      ...
      {/* Desktop View - Table */}
      <div className="hidden md:block bg-background border border-border rounded-lg overflow-x-auto text-foreground">
